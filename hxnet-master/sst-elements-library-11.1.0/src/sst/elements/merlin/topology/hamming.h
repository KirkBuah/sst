...
namespace SST
{
    namespace Merlin
    {
        ...
        private:
            ...
            int jf_nearest_row_edge;           // Local ID of nearest row-edge node (fallback)
            int jf_nearest_col_edge;           // Local ID of nearest col-edge node (fallback)
            std::vector<int> jf_row_gateways;  // Local IDs of ALL row-FT gateway nodes on this board
