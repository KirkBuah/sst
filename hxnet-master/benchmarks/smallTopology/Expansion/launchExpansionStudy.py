...
ALLTOALL_PY  = os.path.join(SCRIPT_DIR, "../AllToAll/launchAllToAll_16nodes.py")
RANDPERM_PY  = os.path.join(SCRIPT_DIR, "../RandomPermutation/launchRandomPerm.py")

# Experiment 1 + 3: scale global_shape while board is fixed 2x2
SCALING_CONFIGS = [
    ("2x2", "1x1"),
    ("2x2", "2x2"),
    ("2x2", "3x3"),
