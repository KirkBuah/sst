...
This readME explains how to reproduce the results of the AllToAll benchmark for the small topologies (~1000 nodes).
...
## Results Only
It is also possible to use the already generated output files to generate the plots. To do so, copy the `output` folder inside `results/AllToAllSmall/` to this folder (`benchmarks/smallTopology/AllToAll/`).
