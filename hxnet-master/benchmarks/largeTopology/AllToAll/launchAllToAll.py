...
sizes = [2**6, 2**8, 2**12, 2**16, 2**18, 2**20]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--topo", type=str, help="Topology to run", default="", choices=["hx4", "hyperx", "hx2", "fattree", "fattree50", "fattre75", "torus", "dragonfly"])
