...
sizes = [2**4, 2**10, 2**12, 2**16, 2**18, 2**20]
#sizes = [512]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--topo", type=str, help="Topology to run", default="", choices=["hx4", "hx2", "hyperx", "fattree", "fattree50", "fattree80", "torus", "dragonfly"])
