...
def main():
    ...
    list_colors = [pa.as_hex()[4], pa.as_hex()[5], pa.as_hex()[6], pa.as_hex()[3], pa.as_hex()[0], pa.as_hex()[1], pa.as_hex()[2]]
    list_colors = ["#7F73AF", "#8F7963", "#CF8FC0", "#C44E52", "#4C72B0", "#DD8452", "#55A868"]
    print(sortednames)
    ...
    plt.title("Random Permutation (2x32 MiB) - Small Topologies (~1000 nodes)", fontsize=23)
    #plt.legend()
    plt.show()
    b.set(ylim=(-1, 1700))
    b.yaxis.set_tick_params(labelsize=17)
